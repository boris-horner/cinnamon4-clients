...
{
    public class C4ObjectType
    {
        public string Name { get; private set; }
        public long? Id { get; private set; }
        public string LocalizedName { get; set; }
        public C4ObjectType(string name, long? id=null) 
        {
            Name = name;
            Id = id;
        }
        public C4ObjectType(XmlElement assetEl)
        {
        ...
        {
            XmlElement assetEl = (XmlElement)parentEl.AppendChild(parentEl.OwnerDocument.CreateElement("objectType"));
