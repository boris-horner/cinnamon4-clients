...
{
    public class LatestTrunkVersionsFilter : IFolderFilter
    {
        public override string ToString()
        {
            return Properties.Resources.lblShowLatestInHead;
        }
        ...
        public CmnNodeList GetNodeList(CmnFolder parent)
        {
            ...
            foreach (IRepositoryNode ow in parent.GetObjects(CmnSession.Versions.Head).Values)
            {
                result.List.Add(ow.Id, ow);
            }
            return result;
