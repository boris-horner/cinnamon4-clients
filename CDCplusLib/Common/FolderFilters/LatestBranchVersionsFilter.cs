...
{
    public class LatestBranchVersionsFilter : IFolderFilter
    {
        public override string ToString()
        {
            return Properties.Resources.lblShowLatestInBranches;
        }
        public string GetKey()
        {
            return "branches";
        }
        public bool ShowsAllVersions { get { return false; } }
        public CmnNodeList GetNodeList(CmnFolder parent)
        {
            ...
            foreach (IRepositoryNode ow in parent.GetObjects(CmnSession.Versions.Branch).Values)
            {
                result.List.Add(ow.Id, ow);
            }
            return result;
