...
{
    public class CutItems : IGenericFunction
    {
        ...
        public void Execute(Dictionary<long, IRepositoryNode> dict)
        {
            ...
            _gad.Clipboard = dict;
            _gad.ClipboardSourceOperation = GlobalApplicationData.ClipboardOperations.ClipboardCut;
        }
