...
namespace C4Admin.GUI.AssetEditors
{
    partial class EditGroup
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblParentGroup.Dock = DockStyle.Top;
            lblParentGroup.Location = new Point(5, 91);
            lblParentGroup.Margin = new Padding(0);
            lblParentGroup.Name = "lblParentGroup";
            lblParentGroup.Padding = new Padding(0, 9, 0, 0);
            lblParentGroup.Size = new Size(76, 24);
            ...
            // pData
            // 
            pData.Controls.Add(cboParentGroup);
            pData.Controls.Add(lblParentGroup);
            ...
            pData.Size = new Size(457, 160);
            pData.TabIndex = 0;
            // 
            // cboParentGroup
            // 
            cboParentGroup.Dock = DockStyle.Top;
            cboParentGroup.DropDownStyle = ComboBoxStyle.DropDownList;
            cboParentGroup.FormattingEnabled = true;
            cboParentGroup.Location = new Point(5, 115);
            cboParentGroup.Name = "cboParentGroup";
            cboParentGroup.Size = new Size(447, 23);
            cboParentGroup.Sorted = true;
            cboParentGroup.TabIndex = 6;
            // 
            // vtxtName
            // 
